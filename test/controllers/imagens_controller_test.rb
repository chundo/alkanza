...
class ImagensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create imagen" do
    assert_difference('Imagen.count') do
      post imagens_url, params: { imagen: { palabra: @imagen.palabra, sitio: @imagen.sitio, url: @imagen.url } }
    end
  ...
  test "should update imagen" do
    patch imagen_url(@imagen), params: { imagen: { palabra: @imagen.palabra, sitio: @imagen.sitio, url: @imagen.url } }
